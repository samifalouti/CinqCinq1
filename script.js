const products = [
  ...
  { name: 'Bledilait', price: '675 DA', image: './products/item8.png', description: 'Description 1' },
  { name: 'Activia', price: '35 DA', image: './products/item9.png', description: 'Description 1' },
  { name: 'Activia', price: '35 DA', image: './products/item10.png', description: 'Description 1' },
  { name: 'Activia', price: '35 DA', image: './products/item11.png', description: 'Description 1' },
  { name: 'Activia', price: '35 DA', image: './products/item12.png', description: 'Description 1' },
  { name: 'Activia', price: '40 DA', image: './products/item13.png', description: 'Activia' },
  { name: 'Aigle 430ml', price: '125 DA', image: './products/item14.png', description: 'AIGLE savon liquide vaisselle citron 430ml' },
  { name: 'Awane', price: '100 DA', image: './products/item15.png', description: 'Description 1' },
  { name: 'Aigle 950ml', price: '170 DA', image: './products/item16.png', description: 'AIGLE Multi Usage savon Liquide moussant parfumé au citron 950ml' },
  { name: 'Aigle 500ml', price: '195 DA', image: './products/item17.png', description: 'AIGLE Dégraissant Professionnel 500ml' },
  { name: 'Aigle Matic Machine', price: '350 DA', image: './products/item18.png', description: 'AIGLE Matic Machine (parfumée aux jasmin) seaux 1kg' },
  { name: 'Aigle Matic Machine', price: '350 DA', image: './products/item19.png', description: 'AIGLE Matic Machine (parfumée aux jasmin) seaux 1kg' },
  { name: 'Frautoire', price: '100 DA', image: './products/item20.png', description: 'Frautoire' },
  { name: 'Candia lait', price: '130 DA', image: './products/item21.png', description: 'Candia le lait partiellement écrémé 1l' },
  { name: 'Amor Benamor couscous', price: '200 DA', image: './products/item22.png', description: 'Amor Benamor Couscous Moyen 1kg' },
  { name: 'Amor Benamor vermicelles', price: '95 DA', image: './products/item23.png', description: 'Amor Benamor Vermicelles N°01 500g' },
  { name: 'Amor Benamor fell', price: '95 DA', image: './products/item24.png', description: 'Amor Benamor Fell 500g' },
  ...
  { name: 'Awane', price: '110 DA', image: './products/item49.png', description: 'Description 1' },
  { name: 'Awane', price: '135 DA', image: './products/item50.png', description: 'Description 1' },
  { name: 'Awane', price: '120 DA', image: './products/item51.png', description: 'Description 1' },
  { name: 'Awane', price: '120 DA', image: './products/item52.png', description: 'Description 1' },
  { name: 'Awane', price: '100 DA', image: './products/item53.png', description: 'Description 1' },
  ...
  { name: 'Candia LeLait 0.5L', price: '80 DA', image: './products/item57.png', description: 'Candia le lait partiellement écrémé 0,5 L' },
  ...
  { name: 'Aigle Top', price: '175 DA', image: './products/item75.png', description: 'Description 1' },
  { name: 'Awane duopack 16', price: '225 DA', image: './products/item76.png', description: 'Description 1' },
  { name: 'Awane duopack 18', price: '240 DA', image: './products/item77.png', description: 'Description 1' },
  ...
  { name: 'Riz Basmati', price: '415 DA', image: './products/item80.png', description: 'Description 1' },
  { name: 'Aigle Savon Liquide', price: '150 DA', image: './products/item81.png', description: 'Description 1' },
  { name: 'Aigle Savon LIquide', price: '150 DA', image: './products/item82.png', description: 'Description 1' },
];
